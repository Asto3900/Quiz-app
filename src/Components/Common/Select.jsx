    ...
    <Box sx={{ minWidth: 220 }} style = {{marginTop:20}}>
      <FormControl fullWidth>
        ...
        >
          ...
          <MenuItem value={10}>Entartaiment:Books</MenuItem>
          <MenuItem value={11}>Entartaiment:Film</MenuItem>
          <MenuItem value={12}>Entartaiment:Music</MenuItem>
          <MenuItem value={13}>Entartaiment:Sport</MenuItem>
          <MenuItem value={14}>Entartaiment:Television</MenuItem>
          <MenuItem value={15}>Entartaiment:Video Games</MenuItem>
